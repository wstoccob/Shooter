...
using wstoccob.Engine.Particles;
using wstoccob.Engine.Particles.EmitterTypes;

namespace wstoccob.Particles
{
    ...
    public class ExplosionEmitter : Emitter
    {
        ...
        public ExplosionEmitter(Texture2D texture, Vector2 position) : base(texture, position, 
            new ExplosionParticleState(), new CircleEmitterType(Radius),  
